public class Duck extends Avian {
     ...
     * @param legs       leg count of resident
     * @param canFly     can resident fly
     */
    public Duck(int age, String color, double weight, boolean endangered, boolean sleeping, double speed, boolean canFly, double legs) {
